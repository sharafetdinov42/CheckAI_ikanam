...
## Стэк технологий
Мы использовали различные библиотеки глубокого обучения, такие как: **PyTorch**, **Transformers**, а так же различные предобученные **LLM**, такие как **RuGPT3-Large**, **LLaMA** и **Mistral 7B**
